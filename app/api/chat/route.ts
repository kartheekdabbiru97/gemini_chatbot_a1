...
// End of system rules.`,
    ...
    tools: {
        ...
        //User defined tool to extract relevant information from the embedded db store
        get_relevant_content: {
          description: "Get relevant content from the database",
          inputSchema: z.object({
            question: z.string().describe("The original normalizedquestion to get relevant content for"),
            similarPhrases: z.array(z.string()).describe("Phrases similar phrases to the original question to cover more simliarity score surface from the vector store"),
          }),
